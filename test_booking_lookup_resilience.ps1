# Testing Booking Lookup and Date/Currency Formatting Resiliency in Node.js
...
const currCases = [
  { input: 2500, expected: '₹2,500', label: 'Normal number 2500' },
  { input: '3500', expected: '₹3,500', label: 'String "3500"' },
  { input: null, expected: '₹0', label: 'null currency' },
  { input: undefined, expected: '₹0', label: 'undefined currency' },
  { input: NaN, expected: '₹0', label: 'NaN currency' }
];
...
[System.IO.File]::WriteAllText("d:\Car-rental-dehradun.com\test_lookup_resilience.js", $testScript, [System.Text.Encoding]::UTF8)
Write-Host "Created test script test_lookup_resilience.js" -ForegroundColor Green
